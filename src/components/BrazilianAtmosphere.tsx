...
export const BrazilianAtmosphere: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-gradient-to-b from-[#002776] via-[#0284c7] to-[#009c3b] flex flex-col items-center justify-between text-slate-800">
      {/* Background Graphic Elements */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Soft sky stars & space particles */}
        <div className="absolute top-2 left-10 w-2 h-2 rounded-full bg-white opacity-80 animate-ping" />
